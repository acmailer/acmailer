...
- **template**: Array with template configuration. It has 3 child options.
	...
	- *childs*: Array with child templates to be used within the main template (layout). Each one of them can have its own childs. Look at `vendor/acelaya/zf2-acmailer/config/mail.global.php.dist` for details.
